...
import { create, createAdmin, deleteUser, getMyAllUsers, getMyTeamLead, getUserById, login, logout, myProfile, UpdateMyProfile, updatePicture, updateUserRecord } from "../controller/user.controller.js";
...
import { admin } from "../middleware/admin.js";
 ...
 userRoute.route("/getMyTeamLead").get(auth,getMyTeamLead)
 userRoute.route("/getUserById/:_id").get(getUserById)
 userRoute.route("/updateMyProfile").put(auth,UpdateMyProfile)
